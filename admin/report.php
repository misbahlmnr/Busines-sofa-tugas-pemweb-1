...
>
  <head>
    ...
    <title>Produk Tersedia | Dashboard - UAS Pemrograman Web</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tentang Aplikasi /</span> Report Bug</h4>

              <div class="card mb-4">
                <h5 class="card-header">Informasi Report</h5>
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Toggle Between Modals -->
                    <div class="col-lg-4 col-md-6">
                      <small class="text-light fw-semibold">Click untuk informasi</small>
                      <div class="mt-3">
                        <button
                          type="button"
                        ...
                        >
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">Anda bisa mereport dengan mengirimkan detail kerentanan ke email <code>misbahdevs@gmail.com</code></div>
