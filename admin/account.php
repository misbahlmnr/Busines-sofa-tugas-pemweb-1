...
<head>
  ...
  <title>Akun Setting | Dashboard - UAS Pemrograman Web</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setting Akun /</span> Akun</h4>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages-account-settings-notifications.html"><i class="bx bx-bell me-1"></i> Notifikasi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages-account-settings-connections.html"><i class="bx bx-link-alt me-1"></i> Koneksi</a>
                  </li>
                </ul>
                <div class="card mb-4">
                  <form id="formAccountSettings" action="../config/HandleForm.php" method="POST" enctype="multipart/form-data">
                    <h5 class="card-header">Detail Profile</h5>
                    <!-- Account -->
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="uploads/<?= $data_user['image']; ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                        <div class="button-wrapper">
                          <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                            <span class="d-none d-sm-block">Upload poto baru</span>
                            <i class="bx bx-upload d-block d-sm-none"></i>
                            <input type="file" id="upload" class="account-file-input" hidden accept="image/png, image/jpeg" name="gambar_akun" />
                          </label>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <input type="hidden" name="gambar_akun_lama" value="<?= $data_user['image']; ?>">
                        <div class="mb-3 col-md-6">
                          <label for="nama_depan" class="form-label">Nama Depan</label>
                          <input class="form-control" type="text" id="nama_depan" name="nama_depan" value="<?= $data_user['nama_depan']; ?>" autofocus required />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="nama_belakang" class="form-label">Nama Belakang</label>
                          <input class="form-control" type="text" name="nama_belakang" id="nama_belakang" value="<?= $data_user['nama_belakang']; ?>" required />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">E-mail</label>
                          <input class="form-control" type="text" id="email" name="email" value="<?= $data_user['email']; ?>" placeholder="misbah@example.com" required readonly />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="organisasi" class="form-label">Organisasi</label>
                          <input type="text" class="form-control" id="organisasi" name="organisasi" value="<?= $data_user['organisasi']; ?>" required />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label class="form-label" for="nomor_hp">Nomor Hp</label>
                          <div class="input-group input-group-merge">
                            <span class="input-group-text">ID (+62)</span>
                            <input type="text" id="nomor_hp" name="nomor_hp" class="form-control" placeholder="0202 555 0111" value="<?= $data_user['nomor_hp']; ?>" required />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="alamat" class="form-label">Alamat</label>
                          <input type="text" class="form-control" id="alamat" name="alamat" placeholder="alamat" value="<?= $data_user['alamat']; ?>" required />
                        </div>
                        <div class="mb-3 col-md-6">
                      ...
                      <div class="mt-2">
                        <button type="submit" name="edit-account" class="btn btn-primary me-2">Save changes</button>
