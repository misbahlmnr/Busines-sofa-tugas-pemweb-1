...
$id_product = $_GET['id'];
$data_product = $obj->get('product', ["id_product = $id_product"]);
$data_product = $data_product->fetch(PDO::FETCH_ASSOC);
...
<head>
  ...
  <title>Edit Produk | Dashboard - UAS Pemrograman Web</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manipulasi Data /</span> Edit Produk</h4>
              ...
              <div class="col-md-6">
                <div class="card mb-4">
                  <form action="../config/HandleForm.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="gambar_product_lama" value="<?= $data_product['image'];?>">
                    <h5 class="card-header">Form Data</h5>
                    <div class="card-body">
                      <div class="mb-3">
                        <label for="nama_product" class="form-label">Nama Produk</label>
                        <input type="text" class="form-control" id="nama_product" name="nama_product" placeholder="masukan nama produk..." value="<?= $data_product['nama_product']; ?>" />
                      </div>
                      <div class="mb-3">
                        <label for="harga_product" class="form-label">Harga Produk</label>
                        <input type="text" class="form-control" id="harga_product" name="harga_product" placeholder="masukan harga produk..." value="<?= $data_product['harga_product']; ?>" />
                      </div>
                      <div class="mb-3">
                        ...
                        <select class="form-select" id="ketersediaan" name="ketersediaan" aria-label="Default select example">
                          <?php if ($data_product['ketersediaan'] === "Tersedia") : ?>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                          <img src="uploads/product/<?= $data_product['image']; ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                          <div class="button-wrapper">
                            <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                              <span class="d-none d-sm-block">Upload poto baru</span>
                              <i class="bx bx-upload d-block d-sm-none"></i>
                              <input type="file" id="upload" class="account-file-input" hidden accept="image/png, image/jpeg" name="gambar_product" />
                            </label>
                          </div>
                        </div>
                      </div>
                      <button type="submit" name="edit_product" class="btn btn-primary mt-2">Edit Produk</button>
                    </div>
                  </form>
                </div>
              </div>
